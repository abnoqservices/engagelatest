    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchImages = async ()=>{
            ...
            try {
                setLoading(true);
                setError(null);
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/product-images", {
                    params: {
                ...
                const galleryImages = (res.data.data || []).filter((item)=>item.type === "gallery" && item.url?.trim()).map((item)=>({
                        id: item.id,
                        url: item.url.trim(),
...
"[project]/components/tempcomponent/sliderTwo.tsx [app-ssr] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/tempcomponent/sliderTwo.tsx [app-ssr] (ecmascript)"));
}),
];

//# sourceMappingURL=components_tempcomponent_sliderTwo_tsx_79261f9a._.js.map