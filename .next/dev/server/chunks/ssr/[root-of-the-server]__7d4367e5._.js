...
function SignUpPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/register", {
                name,
                email,
                password,
