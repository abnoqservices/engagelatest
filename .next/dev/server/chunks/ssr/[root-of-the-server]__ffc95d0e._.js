...
function ProductsPage() {
    ...
    const [totalPages, setTotalPages] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](1);
    ...
    const fetchProducts = async ()=>{
        try {
            const payload = {
                search: searchQuery,
                category_id: categoryFilter === "all" ? null : Number(categoryFilter),
                status: statusFilter === "all" ? null : statusFilter === "active" ? 1 : 0,
                page,
                per_page: perPage
            };
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/products/filter", payload);
            const apiData = res.data.data;
            const productData = apiData.data.map((item)=>({
                    id: item.id,
                    image: item.images?.[0] || "/placeholder-product-image.jpg",
                    name: item.name,
                    sku: item.sku || "N/A",
    ...
    const renderCategoryOptions = (items, level = 0)=>items.flatMap((cat)=>[
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffc95d0e._.js.map