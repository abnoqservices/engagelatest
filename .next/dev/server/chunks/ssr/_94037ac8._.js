...
"[project]/app/landing-pages/new/page.client.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        const fetchSections = async ()=>{
            ...
            try {
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/templates/sections`, {
                    templateId,
                    userId
                });
                if (response.data.status === "success") {
                    ...
                    if (activeSections && activeSections.length > 0) {
                        ...
                        const defaultSections = sections.filter((sec)=>defaultKeys.includes(sec.section)).map((sec)=>({
                                section: sec.section,
                                enabled: true,
                                fields: sec.fields
                            }));
...
//# sourceMappingURL=_94037ac8._.js.map