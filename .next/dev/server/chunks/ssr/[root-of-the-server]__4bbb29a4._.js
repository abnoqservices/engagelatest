...
"[project]/app/products/update/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductPage() {
    ...
    const urlProductId = searchParams.get("id"); // or use router params if using dynamic route
    ...
    const [savingBasic, setSavingBasic] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](false);
    const [savingMedia, setSavingMedia] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](false);
    const [publishing, setPublishing] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](false);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SelectItem"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/app/products/update/page.tsx",
                            lineNumber: 193,
                            columnNumber: 11
                        }, this)
                    }, void 0, false, {
    ...
    const loadProduct = async ()=>{
        ...
        try {
            const [productRes, imagesRes, docsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/products/${productId}`),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/product-images?product_id=${productId}`),
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/product-documents?product_id=${productId}`)
            ]);
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Product loaded successfully", "success");
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(err.response?.data?.message || "Failed to load product", "error");
    ...
    const removeImage = async (id)=>{
        ...
        if (img?.dbId) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/product-images/${img.dbId}`);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Image deleted", "success");
            } catch  {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Failed to delete image", "error");
                return;
            }
        }
    ...
    const removePdf = async (id)=>{
        ...
        if (pdf?.dbId) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/product-documents/${pdf.dbId}`);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Document deleted", "success");
            } catch  {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Failed to delete document", "error");
                return;
            }
        }
    ...
    const handleSaveBasic = async ()=>{
        ...
        if (!formData.price || isNaN(Number(formData.price))) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Valid price required", "error");
        setSavingBasic(true);
        try {
            const payload = {
            ...
            if (isEditMode) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Product updated", "success");
            } else {
                payload.status = "draft";
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/products", payload);
                const newId = res.data?.data?.id || res.data?.id;
                if (newId) {
                    router.replace(`/products/edit?id=${newId}`);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Product created! Now upload media.", "success");
                }
            }
            setActiveTab("media");
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(err.response?.data?.message || "Save failed", "error");
        } finally{
    ...
    const handleSaveMedia = async ()=>{
        ...
        try {
            ...
            for (const [index, img] of selectedImages.entries()){
                if (!img.file) continue; // already in DB
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Media saved successfully", "success");
            setActiveTab("seo");
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(err.message || "Media upload failed", "error");
        } finally{
    ...
    const handlePublish = async ()=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(err.response?.data?.message || "Publish failed", "error");
        } finally{
            setPublishing(false);
        }
    };
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: isEditMode ? `Product ID: ${productId}` : "Step-by-step product creation"
                                    }, void 0, false, {
                                        fileName: "[project]/app/products/update/page.tsx",
                                        lineNumber: 502,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    !isEditMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        onClick: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("Draft saved locally", "success"),
                                        disabled: true,
                                        children: [
                                    ...
                                    activeTab === "seo" && productId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        children: [
                                            ...
                                            formData.status === "published" ? "Update & Republish" : "Publish Product"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/products/update/page.tsx",
                                        lineNumber: 519,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4bbb29a4._.js.map