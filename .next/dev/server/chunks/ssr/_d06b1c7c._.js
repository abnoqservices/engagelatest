        ...
        const fetchProduct = async ()=>{
            try {
                ...
                if (response.data.success) {
                    ...
                    const getField = (names)=>customFields.find((f)=>names.some((n)=>f.name?.toLowerCase() === n.toLowerCase()))?.value?.trim() || "";
                    setLinks({
                        facebook: getField([
                            "facebook",
                            "fb"
...
"[project]/components/tempcomponent/Social.tsx [app-ssr] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/components/tempcomponent/Social.tsx [app-ssr] (ecmascript)"));
}),
...
//# sourceMappingURL=_d06b1c7c._.js.map