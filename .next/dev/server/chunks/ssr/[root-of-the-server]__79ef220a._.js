...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/image.js [app-ssr] (ecmascript)"); // Keep this for optimized images
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/axiosClient.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/showToast.ts [app-ssr] (ecmascript)"); // ← Use toast instead of alert
"use client";
;
;
;
...
function NewProductPage() {
    ...
    const notify = (type, message)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"][type](message);
    };
    // ... (other helpers like generateSafeSku, slugify, etc.)
        ...
        const loadDraft = async ()=>{
            try {
                ...
                if (drafts.length > 0) {
                    ...
                    notify("success", "Draft loaded successfully. Continue editing.");
                }
            } catch (error) {
                notify("error", "Failed to load draft. Starting fresh.");
            }
        };
        loadDraft();
    }, []);
    // Auto-save & other logic (uses notify instead of showAlert)
    const autoSaveDraft = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"](async ()=>{
        ...
        try {
            ...
            if (!currentId) {
                ...
                notify("success", "Draft created automatically.");
            }
            await associateNewMedia(currentId);
        } catch (error) {
            notify("error", `Auto-save failed: ${error.message || "Please try again."}`);
        }
    }, [
        formData,
        tags,
    ...
    // ... rest of upload, remove, associate functions (update to use notify)
    const handleSaveBasic = async ()=>{
        if (!formData.name.trim()) return notify("error", "Product name is required.");
        if (!formData.category) return notify("error", "Category is required.");
        if (!formData.price || isNaN(Number(formData.price))) return notify("error", "Valid price is required.");
        setIsSavingBasic(true);
        try {
            await autoSaveDraft();
            setActiveTab("media");
            notify("success", "Basic info saved!");
        } catch  {
    ...
    const handleSaveMedia = async ()=>{
        ...
        try {
            await autoSaveDraft();
            setActiveTab("seo");
            notify("success", "Media saved successfully!");
        } catch  {
            notify("error", "Failed to save media.");
        } finally{
    ...
    const handlePublish = async ()=>{
        ...
        // Optional: redirect or reset
            ...
            notify("error", `Publish failed: ${error.message || "Try again."}`);
        } finally{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        ...
                                        children: productId ? "Edit Draft" : "Add New Product"
                                    }, void 0, false, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Changes are auto-saved as draft"
                                    }, void 0, false, {
                                        fileName: "[project]/app/products/new/page.tsx",
                                        lineNumber: 187,
                                        columnNumber: 15
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                            className: "flex aspect-square items-center justify-center rounded-lg border-2 border-dashed cursor-pointer hover:border-slate-400 transition",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                                    type: "file",
                                                                    accept: "image/*",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79ef220a._.js.map