...
function ProductsPage() {
    ...
    const fetchProducts = async ()=>{
        try {
            ...
            const apiData = res.data.data.data; // array of products
            // Map API data to Product type (using only required fields)
            // Note: image is set to a placeholder since 'images' is empty array in response
            // scans, views, leads are hardcoded to 0 (add API fields if available later)
            // category uses category.name from nested object
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc2f655a._.js.map