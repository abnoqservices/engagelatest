...
function BulkImportContactsPage() {
    ...
    const [deduplicate, setDeduplicate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const handleFileChange = (e)=>{
        ...
        if (!selected?.name.endsWith('.csv')) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])('Please upload a .csv file', 'error');
            return;
        }
        setFile(selected);
        Papa.parse(selected, {
    ...
    const handleImport = async ()=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])(`Imported ${successCount} contacts successfully`, 'success');
            router.push('/dashboard/contacts');
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])('Bulk import failed', 'error');
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba80d937._.js.map