...
function TopNav({ onMenuClick }) {
    ...
    const getUser = async ()=>{
        try {
            ...
            if (!res.data?.data) {
                showToast("Unable to load your profile. Please try again or login again.", "error");
                return;
            }
            ...
            if (error.response?.status === 500) {
                showToast("Server error while loading your profile.", "error");
                return;
            }
            if (!error.response) {
            ...
            showToast("Something went wrong while loading your profile.", "error");
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41ae8903._.js.map