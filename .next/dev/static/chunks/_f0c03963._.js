...
function NewProductPage() {
    ...
    const previewDataRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    // Trigger re-render of preview component when preview updates
    const [, forcePreviewUpdate] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](0);
    ...
    const buildFinalJson = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "NewProductPage.useCallback[buildFinalJson]": ()=>{
            const sections = templateSections.sections.filter({
                "NewProductPage.useCallback[buildFinalJson].sections": (sec)=>sec.enabled
            }["NewProductPage.useCallback[buildFinalJson].sections"]).map({
                "NewProductPage.useCallback[buildFinalJson].sections": (sec)=>{
                    const data = sectionsData[sec.section] || {};
                    const fields = [];
                    sec.fields.forEach({
                        "NewProductPage.useCallback[buildFinalJson].sections": (field)=>{
                            const value = data[field.name];
                            if (!value || value === "" || Array.isArray(value) && value.length === 0) return;
                            if (field.type === "image") {
                                if (field.multiple && Array.isArray(value)) {
                                    value.forEach({
                                        "NewProductPage.useCallback[buildFinalJson].sections": (img)=>{
                                            if (img.url) fields.push({
                                                name: field.name,
                                                url: img.url
                                            });
                                        }
                                    }["NewProductPage.useCallback[buildFinalJson].sections"]);
                                } else if (value?.url) {
                                    fields.push({
                                        name: field.name,
                                        url: value.url
            ...
            }["NewProductPage.useCallback[buildFinalJson].sections"]).filter(Boolean);
            return {
                userId: 1,
                templateName: "modern",
                product_id: Date.now(),
                ...
                tag: tags,
                images: images.map({
                    "NewProductPage.useCallback[buildFinalJson]": (img)=>img.url
                }["NewProductPage.useCallback[buildFinalJson]"]),
                meta: metaTitle || "",
    ...
    const handleUpdatePreview = ()=>{
        const newData = buildFinalJson();
        previewDataRef.current = newData;
        forcePreviewUpdate((prev)=>prev + 1); // Triggers re-render in preview
        setIsPreviewLoading(false);
    };
    const handlePreviewClick = ()=>{
        setIsPreviewLoading(true);
        // Small visual delay for better UX
        setTimeout(handleUpdatePreview, 400);
    };
    // On first mount: generate initial preview
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "NewProductPage.useEffect": ()=>{
            previewDataRef.current = buildFinalJson();
            forcePreviewUpdate(1);
        }
    }["NewProductPage.useEffect"], [
        buildFinalJson
    ]);
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: previewDataRef.current ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductPreview, {
                                                    data: previewDataRef.current
                                                }, previewDataRef.current.product_id, false, {
                                                    fileName: "[project]/app/products/new/page.tsx",
                                                    lineNumber: 855,
                                                    columnNumber: 11
                                                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-gray-500",
                                                    children: 'Click "Update Preview" to see changes'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/products/new/page.tsx",
                                                    lineNumber: 860,
                                                    columnNumber: 11
...
_s(NewProductPage, "LjKZ8V4N+WcZKaNTzT5OiE2OCSU=");
_c = NewProductPage;
var _c;
...
//# sourceMappingURL=_f0c03963._.js.map