...
function LandingPageClient() {
    ...
    const [metaData, setMetaData] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]({});
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "LandingPageClient.useEffect": ()=>{
            ...
            const fetchData = {
                "LandingPageClient.useEffect.fetchData": async ()=>{
                    try {
                        setIsLoading(true);
                        // Fetch both APIs in parallel
                        const [landingRes, productRes] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/products/${slug}/landing-page`),
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/products/${slug}`)
                        ]);
                        // Handle meta data from product details
                        if (productRes.data?.success && productRes.data?.data) {
                            const product = productRes.data.data;
                            setMetaData({
                                meta_title: product.meta_title || product.name || "Product Preview",
                                meta_description: product.meta_description || "Preview of the product landing page.",
                                keywords: product.keywords || ""
                            });
                        }
                        // Handle landing page sections
                        if (landingRes.data?.success && landingRes.data?.data?.sections?.length) {
                            const activeSections = landingRes.data.data.sections.filter({
                                "LandingPageClient.useEffect.fetchData.activeSections": (sec)=>sec.is_published
                            }["LandingPageClient.useEffect.fetchData.activeSections"]).sort({
                                "LandingPageClient.useEffect.fetchData.activeSections": (a, b)=>a.sort_order - b.sort_order
                            }["LandingPageClient.useEffect.fetchData.activeSections"]);
                            setPayload({
                                templateName: "modern",
                                sections: activeSections.map({
                                    "LandingPageClient.useEffect.fetchData": (sec)=>({
                                            section: sec.global_section.key,
                                            content: sec.content ?? {}
                                        })
                                }["LandingPageClient.useEffect.fetchData"]),
                                styles: {
                        ...
                        // Fallback meta
                        setMetaData({
                            meta_title: "Product Preview",
                            meta_description: "Error loading product details."
                        });
                        // Fallback payload
                        setPayload({
                            templateName: "modern",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$noop$2d$head$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("title", {
                        children: metaData.meta_title || "Product Preview"
                    }, void 0, false, {
                        fileName: "[project]/app/preview/[slug]/page.tsx",
                        lineNumber: 141,
                        columnNumber: 9
                    }, this),
                    metaData.meta_description && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("meta", {
                        name: "description",
                    ...
                    metaData.keywords && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("meta", {
                        name: "keywords",
...
_s(LandingPageClient, "ul4VMtJsXLLEnB5fT6yL1NqyyPM=", false, function() {
    return [
...
//# sourceMappingURL=_b91c19ae._.js.map