    ...
    async function onSubmit(values) {
        ...
        if (values.source_metadata_json?.trim()) {
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Source metadata must be valid JSON', 'error');
                setIsSubmitting(false);
                return;
            }
        }
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/contacts', payload);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])(response.data.message || 'Contact created successfully', 'success');
            router.push(`/dashboard/contacts/${response.data.data.id}`);
        } catch (error) {
            const res = error.response;
            if (res?.status === 409) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])(`Duplicate contact found (ID: ${res.data.data?.duplicate_id || 'unknown'})`, 'warning');
                return;
            }
            if (res?.status === 422) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Please check the highlighted fields', 'error');
                return;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])(res?.data?.message || 'Failed to create contact', 'error');
        } finally{
            setIsSubmitting(false);
        }
    }
...
//# sourceMappingURL=_a55c6d23._.js.map