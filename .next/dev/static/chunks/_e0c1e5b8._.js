...
function SignInPage() {
    ...
    const loginUser = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", {
                email,
                password,
                organization_id
            });
...
_s(SignInPage, "ivABqKOczm8v/0uPYmUEYDbaaRI=", false, function() {
    return [
...
//# sourceMappingURL=_e0c1e5b8._.js.map