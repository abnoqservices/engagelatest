...
function ProductLandingPageBuilder() {
    ...
    // Sections currently on the landing page (from API)
    ...
    // All globally available sections (extracted from active ones + future additions if needed)
    // For now, we derive available sections from what's returned in the response
  ...
  ---------------------------------------------------- */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "ProductLandingPageBuilder.useEffect": ()=>{
            ...
            const fetchLandingPage = {
                "ProductLandingPageBuilder.useEffect.fetchLandingPage": async ()=>{
                    try {
                        setIsLoading(true);
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/products/${productId}/landing-page`);
                        if (response.data.success) {
                            const sections = response.data.data.sections || [];
                            // Sort by sort_order
                            sections.sort({
                                "ProductLandingPageBuilder.useEffect.fetchLandingPage": (a, b)=>a.sort_order - b.sort_order
                            }["ProductLandingPageBuilder.useEffect.fetchLandingPage"]);
                            setActiveSections(sections);
                            // Extract unique global sections for potential future "add section" functionality
                            const globalMap = new Map();
                            sections.forEach({
                                "ProductLandingPageBuilder.useEffect.fetchLandingPage": (sec)=>{
                                    if (!globalMap.has(sec.global_section.key)) {
                                        globalMap.set(sec.global_section.key, {
                                            key: sec.global_section.key,
                                            name: sec.global_section.name,
                                            schema: sec.global_section.schema
                                        });
                                    }
                                }
                            }["ProductLandingPageBuilder.useEffect.fetchLandingPage"]);
                            setAvailableSections(Array.from(globalMap.values()));
                        } else {
                            showToast(response.data.message || "Failed to load landing page", "error");
                        }
                    } catch (error) {
                        console.error("Fetch landing page error:", error);
                        showToast(error.response?.data?.message || "Failed to load landing page", "error");
                    } finally{
                        setIsLoading(false);
                    }
                }
    ...
    const togglePublished = (sectionId)=>{
        setActiveSections((prev)=>prev.map((s)=>s.id === sectionId ? {
                    ...s,
    ...
    const onDragEnd = ({ active, over })=>{
        ...
        setActiveSections((prev)=>{
            ...
            const newArray = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(prev, oldIndex, newIndex);
            // Update sort_order based on new position
            return newArray.map((sec, index)=>({
                    ...sec,
                    sort_order: index + 1
                }));
        });
    ...
    /* ----------------------------------------------------
     SAVE CHANGES (reorder + publish toggle + removals)
  ---------------------------------------------------- */ const handleSave = async ()=>{
        if (!productId) return;
        setIsSaving(true);
        try {
            // You may need a dedicated endpoint to update the landing page.
            // Assuming: PUT /api/products/{productId}/landing-page
            const payload = {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/api/products/${productId}/landing-page`, payload);
            if (response.data.success) {
                showToast("Landing page updated successfully!", "success");
            } else {
                showToast(response.data.message || "Failed to update landing page", "error");
            }
        } catch (error) {
            console.error("Save error:", error);
            showToast(error.response?.data?.message || "Failed to update landing page", "error");
        } finally{
            setIsSaving(false);
        }
    };
  ...
  ---------------------------------------------------- */ const previewPayload = {
        templateName: "modern",
        sections: activeSections.filter((s)=>s.is_published).map((s)=>({
                section: s.global_section.key,
                content: s.content,
                fields: s.global_section.schema?.fields || {}
            })),
        styles: {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                    children: "Drag to reorder, toggle visibility, or remove sections"
                                                }, void 0, false, {
                                                    fileName: "[project]/app/landing-pages/new/page.client.tsx",
                                                    lineNumber: 294,
                                                    columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            children: activeSections.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DndContext"], {
                                                ...
                                                children: "No sections configured for this product yet."
                                            }, void 0, false, {
                                                fileName: "[project]/app/landing-pages/new/page.client.tsx",
                                                lineNumber: 318,
                                                columnNumber: 21
...
_s2(ProductLandingPageBuilder, "QQ2G3tIZYScQYbtZ1tIIiORcvJ0=", false, function() {
    return [
...
//# sourceMappingURL=_604e2947._.js.map