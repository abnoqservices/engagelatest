...
function CustomersPage() {
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/contacts/${selectedContact.id}`, formData);
            if (res.data.success) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Contact updated successfully", "success");
                setSelectedContact(res.data.data || {
                    ...selectedContact,
                    ...formData
                });
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])(err?.response?.data?.message || "Failed to update contact", "error");
        }
    };
    const handleDelete = async ()=>{
        if (!deleteId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/contacts/${deleteId}`);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Contact deleted", "success");
            fetchContacts();
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])(err?.response?.data?.message || "Failed to delete", "error");
        } finally{
            setDeleteId(null);
        }
    };
...
_s(CustomersPage, "aIfjZPGez9Xx8lWrarzVX8U/aOQ=");
_c = CustomersPage;
var _c;
...
//# sourceMappingURL=_6b4c7f64._.js.map