...
function FormsPage() {
    _s();
    const [forms, setForms] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]([]);
    ...
    const loadForms = async ()=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/forms') // GET /api/forms
            ;
            if (res.data.success) {
                setForms(res.data.data || []);
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Failed to load forms", "error");
            }
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Failed to load forms", "error");
            console.error(err);
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/forms/${id}`);
            if (res.data.success) {
                setForms((prev)=>prev.filter((f)=>f.id !== id));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Form deleted successfully", "success");
            }
        } catch (err) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Failed to delete form", "error");
        }
    };
...
_s(FormsPage, "F3dNSS/Wq8oPicRqJU+Ha+axWXY=");
_c = FormsPage;
var _c;
...
//# sourceMappingURL=_b5b128ca._.js.map