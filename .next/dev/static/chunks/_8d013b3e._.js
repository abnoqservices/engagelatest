...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/use-toast.ts [app-client] (ecmascript)"); // Assuming you have shadcn toast
;
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
...
function LandingPageBuilder() {
  ...
  ---------------------------------------------------- */ const updateContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "LandingPageBuilder.useCallback[updateContent]": async (sec, newContent)=>{
            if (!productId || !sec.sectionId) return;
            setActiveSections({
                "LandingPageBuilder.useCallback[updateContent]": (prev)=>prev.map({
                        "LandingPageBuilder.useCallback[updateContent]": (s)=>s.sectionId === sec.sectionId ? {
                                ...s,
                                content: newContent,
                                saving: true
                            } : s
                    }["LandingPageBuilder.useCallback[updateContent]"])
            }["LandingPageBuilder.useCallback[updateContent]"]);
            try {
    ...
    const debouncedUpdate = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "LandingPageBuilder.useMemo[debouncedUpdate]": ()=>{
            let timeout;
            return ({
                "LandingPageBuilder.useMemo[debouncedUpdate]": (sec, content)=>{
                    clearTimeout(timeout);
                    timeout = setTimeout({
                        "LandingPageBuilder.useMemo[debouncedUpdate]": ()=>updateContent(sec, content)
                    }["LandingPageBuilder.useMemo[debouncedUpdate]"], 800);
                    // Optimistic local update
                    setActiveSections({
                        "LandingPageBuilder.useMemo[debouncedUpdate]": (prev)=>prev.map({
                                "LandingPageBuilder.useMemo[debouncedUpdate]": (s)=>s.sectionId === sec.sectionId ? {
                                        ...s,
                                        content
                                    } : s
                            }["LandingPageBuilder.useMemo[debouncedUpdate]"])
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                        children: [
                                                            ...
                                                            activeSections.length === globalSections.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(LandingPageBuilder, "VOGIXoo83jI6+uCEErJw9uY+7bM=", false, function() {
    return [
...
_s1(SortableSectionItem, "iTIyvp0X9kMGpdHRsWsr2+tGbVI=", false, function() {
    return [
...
//# sourceMappingURL=_8d013b3e._.js.map