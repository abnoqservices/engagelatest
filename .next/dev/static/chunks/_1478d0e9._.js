...
function TopNav({ onMenuClick }) {
    ...
    const [fullname, setFullname] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](null);
    ...
    const getUser = async ()=>{
        try {
            ...
            if (!res.data?.data) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Unable to load your profile. Please try again or login again.", "error");
                return;
            }
            ...
            if (error.response?.status === 401) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Session expired. Please login again.", "error");
                localStorage.removeItem("user");
                localStorage.removeItem("token");
            ...
            if (error.response?.status === 500) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Server error while loading your profile.", "error");
                return;
            }
            if (!error.response) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Network error. Please check your internet.", "error");
                return;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$showToast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("Something went wrong while loading your profile.", "error");
        }
    };
...
_s(TopNav, "xMNEUkgX4UT4vhZbLg8air9OamI=", false, function() {
    return [
...
function LandingPagesPage() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const setPageData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pageStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePageStore"])({
        "LandingPagesPage.usePageStore[setPageData]": (state)=>state.setTemplate
    }["LandingPagesPage.usePageStore[setPageData]"]);
...
_s1(LandingPagesPage, "kpWlOYiL8CVXdj5entzxcRnFeMg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
__turbopack_context__.k.register(_c8, "LandingPagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1478d0e9._.js.map