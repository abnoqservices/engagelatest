...
"[project]/app/landing-pages/global-sections/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(SortableSection, "oh9mx5sSbPeTSz0BpFRy4Yuxot8=", false, function() {
    return [
...
function GlobalLandingPageSections() {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "GlobalLandingPageSections.useEffect": ()=>{
            async function loadSections() {
                try {
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/admin/landing-page/sections");
                    console.log("Fetched sections:", res.data);
                    if (res.data.success) {
                        // Ensure sort_order is correct based on array order
                        const sorted = res.data.data.sort({
                            "GlobalLandingPageSections.useEffect.loadSections.sorted": (a, b)=>a.sort_order - b.sort_order
                        }["GlobalLandingPageSections.useEffect.loadSections.sorted"]);
                        setSections(sorted);
                    }
                } catch (err) {
    ...
    const removeSection = async (section)=>{
        if (section.id) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/admin/landing-page/sections/${section.id}`);
            } catch (err) {
    ...
    const saveAll = async ()=>{
        ...
        try {
            ...
            for (const sec of newSections){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/admin/landing-page/sections", {
                    key: sec.key,
                    name: sec.name,
                    group: sec.group,
            ...
            for (const sec of existingSections){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/admin/landing-page/sections/${sec.id}`, {
                    key: sec.key,
                    name: sec.name,
                    group: sec.group,
                    sub_group: sec.sub_group,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-4",
                                                        children: [
                                                            section.schema.fields.map((field)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            section.schema.fields.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s1(GlobalLandingPageSections, "ReZDRh6s6gl/clHe+douMyotQIA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSensors"]
    ];
});
_c1 = GlobalLandingPageSections;
var _c, _c1;
__turbopack_context__.k.register(_c, "SortableSection");
__turbopack_context__.k.register(_c1, "GlobalLandingPageSections");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_42c3664f._.js.map